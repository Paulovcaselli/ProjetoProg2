...
public class TCadastroUsuario extends javax.swing.JFrame {
    ...
    private void jButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarActionPerformed
        Usuario usuario = new Usuario(jTextFieldCLogin.getText(), String.valueOf(jTextFieldCSenha.getText()), 
                jTextFieldCNome.getText(), jTextFieldCEmail.getText(), FachadaUsuario.getInstance().listar().listar());
        try {
