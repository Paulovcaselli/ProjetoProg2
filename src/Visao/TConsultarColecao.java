...
import Negocios.ControleColecoes;
...
public class TConsultarColecao extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		// DefaultListModel meters = ( DefaultListModel ) jlistColecao.getModel();
		...
		jComboBoxColecaoManga.setModel(
		...
		ControleColecoes items = FachadaUsuario.getInstance().listar();
		Object[] itemObj = new Object[100];
		int idx= 0;
		for (Object object : itemObj) {
			//itemObj[idx++]= o
		}
		DefaultComboBoxModel model = new DefaultComboBoxModel(itemObj);
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(TConsultarColecao.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
